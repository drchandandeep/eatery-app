...
// different constant).
//
// There is no minimum -- a store can legitimately serve just its own street
// or a tight neighbourhood, right down to 0km. Orders are allowed up to
// 7km from the store -- see MAX_SERVICE_RADIUS_KM below.
const MIN_SERVICE_RADIUS_KM = 0;
